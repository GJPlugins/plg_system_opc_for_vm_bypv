	...
	<fieldset class="clean">
		<?php if (!$LOGIN->IS_USER_LOGGED) { ?>
			...
			<table class="clean">
				<tbody>
					<tr class="username">
						<td class="label"><label for="cart_username"><?php echo JText::_('JGLOBAL_USERNAME'); ?></label></td>
						<td class="value"><input id="cart_username" name="username" type="text" /></td>
					</tr>
	
					<tr class="password">
						<td class="label"><label for="cart_password"><?php echo JText::_('JGLOBAL_PASSWORD'); ?></label></td>
						<td class="value"><input id="cart_password" name="password" type="password" /></td>
					</tr>
