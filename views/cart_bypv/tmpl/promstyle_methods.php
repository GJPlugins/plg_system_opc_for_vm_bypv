<?php defined( '_JEXEC' ) or die( 'Restricted access' );
	...
	if ( !empty( $this->METHODS->INFO_HTML ) )
	{
		$INFO_HTML = '<div class="info">' . $this->METHODS->INFO_HTML . '</div>';
	} ?>


    <?php if ( !$this->METHODS->INFO_HTML_POSITION )
	{
		echo $INFO_HTML;
	}
...
<?php
	if ( $this->METHODS->INFO_HTML_POSITION )
	{
		echo $INFO_HTML;
	}
